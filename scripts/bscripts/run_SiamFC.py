...
def parse_arguments():
    with open('/home/ubuntu/siamfc-tf/parameters/hyperparams.json') as json_file:
        hp = json.load(json_file)
    with open('/home/ubuntu/siamfc-tf/parameters/evaluation.json') as json_file:
        ev = json.load(json_file)
    with open('/home/ubuntu/siamfc-tf/parameters/run.json') as json_file:
        run = json.load(json_file)
    with open('/home/ubuntu/siamfc-tf/parameters/environment.json') as json_file:
        env = json.load(json_file)
    with open('/home/ubuntu/siamfc-tf/parameters/design.json') as json_file:
